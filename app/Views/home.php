        ...
        <div class="row" style="margin-left: -100px;">
          <div class="col d-flex justify-content-around">
            <div class="row d-flex flex-column">
              <h1 class="location">Yogyakarta</h1>
              <div class="temperature">38&deg;</div>
            </div>
            <div class="row">
              <div class=" p-0 icon-large text-warning">&#9728;</div>
            </div>
          </div>
        </div>
              ...
              <div class="row text-white">
                <div class="col-md-6 mb-3 d-flex align-items-center">
                  ...
                  <div class="text-start">
                    <div>Suhu</div>
                    <div class="fw-bold" style="font-size: 1.5rem;">38&deg;</div>
                  </div>
                </div>
                <div class="col-md-6 mb-3 d-flex align-items-center">
                  ...
                  <div class="text-start">
                    <div>Angin</div>
                    <div class="fw-bold" style="font-size: 1.5rem;">0.2 Km/jam</div>
                  </div>
                </div>
                <div class="col-md-6 mb-3 d-flex align-items-center">
                  ...
                  <div class="text-start">
                    <div>Kelembapan</div>
                    <div class="fw-bold" style="font-size: 1.5rem;">10%</div>
                  </div>
                </div>
                <div class="col-md-6 mb-3 d-flex align-items-center">
                  ...
                  <div class="text-start">
                    ...
                    <div class="fw-bold" style="font-size: 1.5rem;">5 M</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-4">
        <div class="card shadow">
          ...
          <div class="card-body text-light">
            <div class="col d-flex flex-column gap-3 justify-content-around">
              <div class="row ">
